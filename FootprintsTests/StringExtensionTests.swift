    ...
    func testString_randomWord_createsARandomWord() {
        ...
        for test in testParameterArray {
            ...
            let randomWord = String.randomWord(
                length: test[0] as! ClosedRange<Int>,   // swiftlint:disable:this force_cast
                includeDigits: test[1] as! Bool,    // swiftlint:disable:this force_cast
                includeCapitals: test[2] as! Bool   // swiftlint:disable:this force_cast
            )

            // then
            assertInRange(
                randomWord.count,
                in: test[0] as! ClosedRange<Int>,   // swiftlint:disable:this force_cast
                test[3] as! String      // swiftlint:disable:this force_cast
            )
        }
    }
